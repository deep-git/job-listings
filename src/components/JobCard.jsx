        ...
        <div className="flex flex-col sm:flex-row w-full">
            ...
            <div className="flex flex-col border-b-[2px] sm:justify-center sm:border-none sm:w-[50%] sm:items-center lg:items-start lg:ml-5 lg:w-[40%]">
                <div className="flex font-bold flex-wrap">
                    <p className="text-desaturated_darkcyan">{job.company}</p>
                ...
                <p className="mt-2 text-md font-bold lg:text-xl lg:mt-1 hover:text-desaturated_darkcyan hover:cursor-pointer">{job.position}</p>
            ...
            {/* JOB TAGS */}
            <div className="flex flex-wrap text-desaturated_darkcyan font-bold mt-3 gap-3 sm:flex-col w-full sm:w-[50%] sm:mb-3 sm:justify-center text-center lg:flex-row lg:w-[60%] lg:h-auto lg:mt-0 lg:items-center lg:justify-end">
